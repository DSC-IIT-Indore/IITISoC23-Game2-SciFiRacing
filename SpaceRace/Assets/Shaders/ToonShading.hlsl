void ToonShading_float(in float3 Normal, in float ToonRampSmoothness, in float3 CliSpacePos, in float3 WorldPos, in float4 ToonRampTinting,
in float ToonRampOffset, out float3 ToonRampOutput, out float3 Direction)
{
        ...
        half d = dot(Norma, light.direction)*0.5 + 0.5;
